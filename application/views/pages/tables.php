...
<script src="<?= RESOURCES_FOLDER ?>bower_components/datatables/media/js/jquery.dataTables.min.js"></script>
<link href="<?= RESOURCES_FOLDER ?>bower_components/datatables/media/css/jquery.dataTables.min.css" rel="stylesheet">
